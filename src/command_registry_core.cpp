...
void CoreCommandRegistry::registerStringFunctions(CommandRegistry& registry) {
    // LEN - String length
    CommandDefinition len("LEN", "Return length of string", "string.len", "string");
    len.addParameter("str", ParameterType::STRING, "Input string")
       .setReturnType(ReturnType::INT);
    registry.registerFunction(std::move(len));
    ...
    CommandDefinition instr("INSTR", "Find position of substring", "string_instr", "string");
    instr.addParameter("haystack", ParameterType::STRING, "String to search in")
         .addParameter("needle", ParameterType::STRING, "String to search for")
         .addParameter("start", ParameterType::INT, "Starting position", true, "1")
         .setReturnType(ReturnType::INT);
    registry.registerFunction(std::move(instr));
    ...
    CommandDefinition hex("HEX$", "Convert number to hexadecimal string", "string_hex", "string");
    ...
    CommandDefinition bin("BIN$", "Convert number to binary string", "string_bin", "string");
    ...
    CommandDefinition oct("OCT$", "Convert number to octal string", "string_oct", "string");
...
void CoreCommandRegistry::registerSystemFunctions(CommandRegistry& registry) {
    ...
    CommandDefinition timer("TIMER", "Get elapsed time in seconds", "system_timer", "system");
